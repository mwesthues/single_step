...
Chapter \@ref(loocv-prediction-without-prediction-error-estimates) deals with 
the results of hybrid prediction for the reduced set of data and a comparison
of predictive abilities with the full data set.

Chapter \@ref(efficient-loocv-with-prediction-errors) is a first implementation
of the approach suggested by Cheng, Garrick and Fernando (2016, unpublished)
using a data set from the `BGLR` package.

Chapter \@ref(prediction-with-imputed-mrnas) examines the influence of certain levels of missingness 
in the transcriptomic data.

Chapter \@ref(conclusions-and-outlook) provides a summary of the analyses and 
provides an outlook for future analyses.
