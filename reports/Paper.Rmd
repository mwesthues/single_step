---
title: Omics-based Single Step Trait Prediction
author:
...
$18$ to $30^{\circ}$N and from $102$ to $110^{\circ}$E [@Yang2014].
...
when fixed effects have been accomodated by the dependent variable [@Mrode2014].
...
\begin{equation} (\#eq:GenomicRelationship)
  \mathbf{K}_{lo} = \frac{1}{W_{lo}} \mathbf{W}_{lo} \mathbf{W}_{lo}^{\top},
\end{equation}

where $W_{lo}$ denotes the number of features [@VanRaden2008].
...
![Bullshit]("./tabs_figs/core_fraction_predictive_ability_trend.pdf")
