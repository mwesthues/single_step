...
a)   Reduced
   ...
   -   Genomic do not clearly perform better than pedigree data except for ADF
     and FAT.

   -   Transcripts perform poorly for DMC and STA.
...
b)   Full
   ...
   -   Predictive abilities for the combination of pedigree, SNP and 
     transcriptomic data "ped100-snp77-mrna42" seem to be the result of the
   ...
   -   The predictive ability of only two predictors is typically higher than a
     weighted average of the predictive abilities of the consituting
     individual predictors.

   -   Predictive abilities for FAT and the predictor combination
     "ped100-snp77-mrna42" are difficult to explain.
