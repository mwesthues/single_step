...
by~\citeNP{Yang2014}.
Best linear unbiased predictors (BLUPs) were calculated by~\citeN{Yang2014} for
...
According to the notation in \citeNP{Fernando2014} the phenotypes can be
untangled as:
...
would be as straightforward as computing the Kronecker product between extension of single step prediction 
...
A larger dataset was available to~\citeN{Ashraf2016}, who imputed genotypes
...
slightly different from those reported by~\citeN{Guo2016}, for three
possible reasons:
...
\citeN{Guo2016} used genotypes from four different subpopulations with a model
...
of 164 inbred lines, whereas~\citeN{Guo2016} applied the quality checks to 368
genotypes.
3) While~\citeN{Guo2016} used five-fold cross-validation with 500 repetitions,
...
progeny.
\citeN{Westhues2017} have shown that, in hybrid breeding, the probability 
