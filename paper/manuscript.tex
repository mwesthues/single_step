...
17 traits of which six are presented in this study (Table~\ref{table:TraitKey}).
The selection of these traits was done so that two traits were predicted with
greater precision by transcriptomic data and four further traits were predicted
...
incomplete predictor $\tensor[_{I}]{\mathbf{W}}{_{2}}$ by calculating
