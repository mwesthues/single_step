...
\Genetics2level{Coverage of the genetic space}
Animal populations are so large that it the assembly of a core set of
individuals with records on multiple predictors can effectively be done at 
random once more than 10,000 animals have pedigree records 
