...
\citeNP{Legarra2009} and \citeNP{Christensen2010} independently from each other
...
subgroups classified by~\citeN{Guo2016}.
All inbred lines were evaluated in five different environments in China
described in detail by~\citeNP{Yang2014}.
...
whereas \citeN{Guo2016} used genotypes from four different subpopulations with a 
...
subset of 164 inbred lines, whereas~\citeN{Guo2016} applied the quality checks to
368 genotypes.
Third, while~\citeN{Guo2016} used five-fold cross-validation with 500 repetitions,
