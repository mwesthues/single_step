...
Population structure in Exp1 was examined by running a STRUCTURE
...
features.
Note that $l$ is only defined for Exp2 where a distinction between 
...
residual error.
For the hybrid data from Exp2, we fit separate additive effects for 
...
For the maize diversity panel inbred lines from Exp1, we fit random 
